...
DEADMAN_PIN = 40
PWM_FREQ= 200
MOTOR_FORWARD_START_DEFAULT=30.61
...
class e116RacecarNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('servo_min', SERVO_CENTER_DEFAULT-8.0)
        self.declare_parameter('servo_max', SERVO_CENTER_DEFAULT+8.0)
        self.declare_parameter('servo_center', SERVO_CENTER_DEFAULT)

        self.declare_parameter('motor_range', 2.5)
        ...
        self.declare_parameter('angle_scale', 25.0) #slightly smaller than 10*180/(20*pi)
        self.declare_parameter('speed_dead_area', 0.2)
